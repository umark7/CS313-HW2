...
#ifndef H_StackType // defining header file
#define H_StackType // defining header file
 
#include <iostream> // including iostream library
#include <cassert>  // importing assert.h header file
 
#include "stackADT.h" // include the stack header file
...
#endif // End of using the header files we called earlier